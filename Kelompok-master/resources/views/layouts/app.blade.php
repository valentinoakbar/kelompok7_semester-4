...
<html lang="en">
  <head>
    ...
    <title>Healty Care</title>
    <!-- Meta, title, CSS, favicons, etc. -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/png" sizes="32x32" href="{{URL::to('images/sign.png')}}">
    {{-- Select2 --}}
...
<footer>
<div class="center">
Developed with <i class="fa fa-heart" style="color: red"></i> by <a href="https://www.instagram.com/ikul_12/">Kelompok 7 semester 4</a>
</div>
<div class="clearfix"></div>
</footer>
<!-- /footer content -->
